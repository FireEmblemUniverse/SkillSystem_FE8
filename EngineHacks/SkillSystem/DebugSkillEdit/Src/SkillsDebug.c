...
static int SkillListCommandDraw(struct MenuProc* menu, struct MenuItemProc* command);
static u8 SkillListCommandIdle(struct MenuProc* menu, struct MenuItemProc* command);
static u8 SkillListCommandSelect(struct MenuProc* menu, struct MenuItemProc* command);

static u8 RemoveSkillCommandSelect(struct MenuProc* menu, struct MenuItemProc* command);

static int ReplaceSkillCommandDraw(struct MenuProc* menu, struct MenuItemProc* command);
static u8 ReplaceSkillCommandIdle(struct MenuProc* menu, struct MenuItemProc* command);
static u8 ReplaceSkillCommandSelect(struct MenuProc* menu, struct MenuItemProc* command);
...
static const struct ProcCmd Proc_SkillDebug[] =
{
    PROC_CALL(LockGame),
...
static const struct MenuItemDef MenuCommands_SkillDebug[] =
{
    {
...
static const struct MenuDef Menu_SkillDebug =
{
    .rect = { 1, 11, 16 },
...
static void SkillListCommandDrawIdle(struct MenuItemProc* command)
{
