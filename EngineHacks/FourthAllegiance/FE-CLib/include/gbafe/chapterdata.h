...
struct ROMChapterData {
	...
	/* 26 */ u16 factionRelations; // Unused in vanilla, Used by fourth allegiance
	/* 28 */ u16 mapSpritePaletteId; // Unused in vanilla, Used by per chapter faction palette hack
	/* 2A */ u8 _unk26[0x2C - 0x2A];
...
const struct ROMChapterData *GetChapterDefinition(int chapterId);
