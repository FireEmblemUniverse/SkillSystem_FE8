...
.macro draw_stats_box showBallista=0
  ...
  ldr     r4, =#0x2020188 	@gGenericBuffer
  mov     r1, r4
  blh     #0x8012F50 		@Decompress
  ...
  blh     #0x8086E00        @DrawStatscreenTextMap
  ...
  ldr     r6, =#0x203A4EC 	@gActiveBattleUnit
  mov     r0, r6
  ...
  blh     #0x8004B94 		@DrawUiNumber
  add     r4, #0x8E
  ldr     r0, =#0x203A4EC 	@gActiveBattleUnit
  add     r0, #0x62 		@load battle avoid
  mov     r1, #0x0
  ldsh    r2, [r0, r1]
  mov     r0, r4
  ...
  mov     r0, r5
  blh     #0x8016CC0 		@GetItemRangeString
  mov     r5, r0
  ldr     r4, =#0x2003CB4
  blh     #0x8003EDC 		@Text_GetStringTextWidth
  mov     r1, #0x37
  sub     r1, r1, r0
  mov     r0, r4
  mov     r2, #0x2
  mov     r3, r5
  blh     #0x8004480, r4 	@Text_InsertString
  mov     r4, #0x0
  ldr     r0, =#0x2003D2C
  ldr     r3, =#0x7060
  mov     r5, r3
...
.macro draw_items_text showBallista=0
  ...
  mov     r0, r2
  blh     #0x80179D8		@GetUnitItemCount
  sub     r0, #0x1
  cmp     r4, r0
  ...
  add     r3, r6, r3
  mov     r1, r5
  blh     #0x8016A2C, r5	@DrawItemOnStatscreen
  mov     r0, #0x2
  add     r8, r0
  add     r6, #0x80
  add     r4, #0x1
