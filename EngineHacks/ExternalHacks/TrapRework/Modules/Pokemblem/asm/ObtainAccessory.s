...
.global ObtainSkillAccessoryInitialization
.type ObtainSkillAccessoryInitialization, %function
.global ObtainStatAccessoryInitialization
.type ObtainStatAccessoryInitialization, %function

.global ObtainSkillAccessoryUsability0x14
.type ObtainSkillAccessoryUsability0x14, %function
.global ObtainStatAccessoryUsability0x13
.type ObtainStatAccessoryUsability0x13, %function


.global ObtainSkillAccessoryEffect
.type ObtainSkillAccessoryEffect, %function
.global ObtainStatAccessoryEffect
.type ObtainStatAccessoryEffect, %function
...
@.equ GiveItemEvent, ObtainSkillAccessoryID+4

ObtainStatAccessoryInitialization:
mov r0, #0x3
...
ObtainSkillAccessoryInitialization:
mov r0, #0x3
ldrb r0, [r5, r0]     @Completion flag
...
ObtainSkillAccessoryUsability0x14:
push {r4,r7,r14}
mov r7, #0x14
b ObtainSkillAccessoryUsability

ObtainStatAccessoryUsability0x13:
push {r4,r7,r14}
mov r7, #0x13

b ObtainStatAccessoryUsability
...
ldr r1,=MemorySlot0
str r2,[r1, #0x04*5]		@overwrite s5 

ldr	r0, =GiveSkillAccessoryEvent	@this event gives item found in byte 0x4 of the trap
...
mov r0, #5 
ldrb r2, [r4, r0] @ stat boost id 
cmp r2, #0
beq DeleteTrap


ldr r1,=MemorySlot0
str r2,[r1, #0x04*4]		@overwrite s4 

ldr	r0, =GiveStatBoostAccessoryEvent	@this event gives item found in byte 0x4 of the trap
mov	r1, #0x01		@0x01 = wait for events
ldr r3, ExecuteEvent
bl goto_r3
