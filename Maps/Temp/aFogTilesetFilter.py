...
parser.add_argument('-r', default=31, type=int, help='Red value modifier, [-31, 31]. Default is 4')
parser.add_argument('-g', default=0, type=int, help='Green value modifier, [-31, 31]. Default is -16')
parser.add_argument('-b', default=0, type=int, help='Blue value modifier, [-31, 31]. Default is -16')
