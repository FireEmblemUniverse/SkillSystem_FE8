...
struct MUProc* MU_CreateForUI(struct Unit* unit, u8, u8); //! FE8U = (0x080784F4+1)
...
u8 GetFacingDirection(u8 xStart, u8 yStart, u8 xEnd, u8 yEnd);



// Mokha
extern u8* gUnitMoveBuffer;	// 0x2033EFC
extern u8 MuCtr_StartMoveTowards(Unit*, u8 x, u8 y, u8); //0x8079DDD
