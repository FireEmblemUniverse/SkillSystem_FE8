...
@ AiTryDoOffensiveAction at 803D450 
@ AiTrySimulateBattle uses 1.2m cycles 
@ AiTryDoOffensiveAction uses 2.9m cycles or ~9 frames  
@ 16m cycles or 53 frames 

@ FE8U
.equ AiData, 0x203AA04	@{U} @ [203AA81]!!
