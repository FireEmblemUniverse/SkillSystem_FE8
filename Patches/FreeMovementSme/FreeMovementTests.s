...
@.equ TryPrepareEventUnitMovement, 0x0800FC91
@.equ GetSomeEventEngineMoveRelatedBitfield, 0x0800FCD9 

.equ Event2F_MoveUnit, 0x0800FD8D
@.equ Event30_ENUN, 0x0800FF25
.equ STAL, 0x0800DB38

@.equ MyTest, 0x800FC91 @BL to TryPrepareEventUnitMovement //does nothing 

.equ MuCtr_CreateWithReda, 0x08079DDD @execute this //works the same 
@.equ MuCtr_After, 0x800FEF8

.equ HideUnitSMS, 0x802810D @BL to 

@
@0807A1FC MuCtr_OnEnd
@0807A358 MuCtr_ExecREDA_807A358

@89A2938 Procs_MoveUnitStep
...
.equ BLMuCtr_CreateWithReda,0x800FEF5 @r0 = char struct, target x coord, target y coord
...
@ldr r0, =#0x803D98
@blh HideUnitSMS @doesn't seem to do anything 
...
mov r0, #0x4F
blh STAL
@blh MuCtr_CreateWithReda @MuCtr_CreateWithReda
@Mytest
