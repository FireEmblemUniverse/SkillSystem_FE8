...
void sub_8026C1C(struct Unit* param_1, int param_2) {
    ...
    uVar15 = 0;
    iVar9 = __umodsi3(GetGameClock(), 0x48);
...
void SyncUnitSpriteSheet(void) {
    int frame = __umodsi3(GetGameClock(), 72);
...
void ForceSyncUnitSpriteSheet(void) {
    ...
    frame = __umodsi3(GetGameClock(), 72);
...
void PutUnitSpriteIconsOam(void) {
    ...
    displayRescueIcon = (__umodsi3(GetGameClock(), 32)) < 20 ? 1 : 0;

    poisonIconFrame = __umodsi3((GetGameClock() / 8),  ARRAY_COUNT(sPoisonIconSprites));
    sleepIconFrame = __umodsi3((GetGameClock() / 16), ARRAY_COUNT(sSleepIconSprites));
    berserkIconFrame = __umodsi3((GetGameClock() / 8), ARRAY_COUNT(sBerserkIconSprites));
    silenceIconFrame = __umodsi3((GetGameClock() / 4), ARRAY_COUNT(sSilenceIconSprites));
