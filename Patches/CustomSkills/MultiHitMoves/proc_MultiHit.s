...
mov r0, #16 @16% chance of 5 hits 
blh d100Result
cmp r0, #1
beq FiveHits
mov r0, #19 @84% chance we made it here, so 16% / 0.84 = 19% to use now
blh d100Result
cmp r0, #1
beq FourHits

mov r0, #50 @68% chance we made it here, so 34% / 0.68 = 50% to use now
blh d100Result
cmp r0, #1
beq ThreeHits
b TwoHits
...
mov     r0, r5 @number of extra attacks
strb    r0,[r4,#6]
b End
